...
pub const Instruction = packed struct {
    ...
    pub const NewTable = packed struct {
        ...
        pub fn setArraySize(self: *NewTable, num: moonlet.object.FloatingPointByteIntType) void {
            self.instruction.b = @intCast(moonlet.object.intToFloatingPointByte(num));
        }

        pub fn setTableSize(self: *NewTable, num: moonlet.object.FloatingPointByteIntType) void {
            self.instruction.c = @intCast(moonlet.object.intToFloatingPointByte(num));
        }
    };
